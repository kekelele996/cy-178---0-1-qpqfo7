...
import EchoRequestPage from './pages/EchoRequestPage.jsx';
    ...
    <div className="app-shell">
      <header className="app-header">
        ...
        <nav className="app-nav">
          ...
          <button className="nav-btn" onClick={() => navigate(ROUTES.ECHO_WALL)}>
            🔊 {LABELS.ECHO_WALL}
          </button>
          {penName && (
            <>
